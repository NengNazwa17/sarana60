...
<head>
    ...
    <title>Arsip Pengaduan - Admin SIPRAS</title>
...
<body class="bg-gray-50 text-gray-800 antialiased min-h-screen flex">
    ...
    <aside class="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col sticky top-0 h-screen shadow-sm">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            <a href="{{ route('admin.pengaduan.arsip') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-red-50 text-red-600 font-medium transition hover:bg-red-50 group">
    ...
    <main class="flex-1 min-w-0 flex flex-col">
        ...
        <header class="h-16 flex items-center justify-between px-6 lg:px-10 bg-white border-b border-gray-200 sticky top-0 z-10">
            <div class="flex items-center gap-4">
                <h1 class="text-xl font-semibold text-gray-800">Arsip Pengaduan</h1>
            </div>
            <div class="flex items-center gap-4">
        ...
        <div class="p-6 lg:p-10 flex-1 overflow-y-auto">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Riwayat Laporan</h2>
                    <p class="text-gray-500 mt-1">Laporan yang sudah berstatus Selesai atau Ditolak tersimpan dengan aman di sini.</p>
                </div>
                
                <!-- Filter Form -->
                <form action="{{ route('admin.pengaduan.arsip') }}" method="GET" class="flex items-center gap-2">
